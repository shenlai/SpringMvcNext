...
public class TestOrderInterceptor implements HandlerInterceptor {
    ...
    public boolean preHandle(HttpServletRequest request,
        ...
        System.out.println("Second preHandle 这个方法会最先执行..");
        return true;
    }
    ...
    public void postHandle(HttpServletRequest request,
        ...
        System.out.println("Second postHandle 执行目标方法之后调用，但是在渲染视图之前，就是转向jsp页面之前调用");
    }
    ...
    public void afterCompletion(HttpServletRequest request,
            ...
            throws Exception {
        System.out.println("Second afterCompletion 在渲染视图之后被调用");
    }
}
